    ...
    >
      {slides.map((slide, index) => (
        <SwiperSlide key={index} className="relative">
          ...
          <div className="absolute  top-1/2 right-0 xl:right-10 transform -translate-y-1/2 bg-transparent bg-opacity-50 text-white font-bold p-2 rounded hidden md:flex flex-col items-start  max-w-md md:max-w-lg  xl:max-w-xl">
