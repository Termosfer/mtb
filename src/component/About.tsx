import img1 from "../assets/valery-tenevoy-zlkqsup_wu8-unsplash.webp";
import img2 from "../assets/bermix-studio-00heEp9LFP0-unsplash.webp";
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16 pb-16 md:pb-20">
        ...
        <div className="text-left w-full lg:w-1/2">
          ...
          <p className="pt-4 text-sm sm:text-base   md:text-base  2xl:text-base text-gray-700 leading-8 lg:leading-12">
            MTB İncorporate MMC 2009-cu ildə təsis edilmiş və tibbi təhsil,
            farmakologiya sahəsində ixtisaslaşmış, beynəlxalq təcrübəyə malik
            tədris mərkəzidir. Fəaliyyətimizin əsas məqsədi səhiyyə
            mütəxəssislərinin bilik və bacarıqlarını müasir yanaşmalar əsasında
            inkişaf etdirməkdir.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center gap-10 md:gap-16">
        <div className="text-left w-full lg:w-1/2">
          ...
          <p className="pt-4 text-sm sm:text-base  md:text-base 2xl:text-base text-gray-700 leading-8 lg:leading-12">
            ...
            MTB İncorporate MMC daim beynəlxalq təcrübəni öyrənir və bu sahədə
            maarifləndirmə işləri üçün mütəxəssisləri cəlb edir. Təlimlərimiz
            real təcrübəyə əsaslanır və beynəlxalq standartlara uyğun
            hazırlanır.
          </p>
        </div>
